% !TEX encoding = UTF-8
\cvJobPosition{Software Engineer}{2015}{2020}{Gloobes, La Plata, Provincia de Buenos Aires, Argentina}{
	
	\cvProjectName{Plataforma Ecommerce multiregional}
	...
	\cvProjectName{Emisión de comprobantes fiscales electrónicos}
	\begin{itemize}
	...
	\cvProjectName{Integración de Punto de Venta Web (POS) y Hardware Fiscal}
